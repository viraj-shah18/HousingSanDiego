...
export default function Collection () {
    ...
    // setcollectionList(...collectionsList, ...allcollections)
    ...
    function AddCollectionInput() {
      ...
      const sendTextInput = event => {
        ...
        setcollectionList([
          ...collectionsList,
          {id: currMax, name: textInput, num_places: 0, img: ''}
        ]);
      }
    ...
    return (
      <Box sx={style}>
        ...
        <Box sx={{ flexGrow: 1, maxHeight: 300, overflow: 'auto' }}>
          {collectionsList.map(collection => (<CollectionListComponent id={collection.id} name={collection.name} num_places={collection.num_places} img={collection.img}/>))}
        </Box>
